...
global $AppUI, $macroprojects, $currentTabId, $dPconfig, $m; // Get the global var

// Check permissions for this module
if (!getPermission($m, 'view')) $AppUI->redirect("m=public&a=access_denied");
...
$company_prefix = 'c_'; // Config
$today = new CDate(); // Set today
...
<script type="text/javascript" src="./modules/finances/js/jquery.js">
</script>
<script type="text/javascript" src="./modules/finances/js/jquery.ui.js">
</script>
<script type="text/javascript" src="./modules/finances/js/jquery.treeTable.js">
</script>
<script type="text/javascript" src="./modules/finances/js/finances.js">
</script>
...
<script type="text/javascript">
	...
	function getCurrency(){
		...
		if(radios[2].checked) 	return "млн.<?php echo $dPconfig['currency_symbol']; ?>";
		if(radios[1].checked)	return "тыс.<?php echo $dPconfig['currency_symbol']; ?>";
...
<form id="mainFrm" name="mainFrm" action="?m=macroprojects&tab=<?php echo $currentTabId; ?>" method="post">
	...
	<table class="tbl" align="center" border="0" cellspacing="0" cellpadding="4"  width ="900">
		<tbody>
			<tr>
				...
				<td align="left" nowrap><label for="currency1"><input type="radio" name="currency" id="currency1" value="1" onChange="javascript:submitWithExpandList(this);" <?php if($currency == "1") echo 'checked'; ?> /><?php echo "тыс.".$dPconfig['currency_symbol']; ?></label></td>
				<td align="left" nowrap><label for="currency2"><input type="radio" name="currency" id="currency2" value="2" onChange="javascript:submitWithExpandList(this);" <?php if($currency == "2") echo 'checked'; ?> /><?php echo "млн.".$dPconfig['currency_symbol']; ?></label></td>
...
<!-- Main table -->
<table class="treeTable" border="1" cellspacing="0" cellpadding="0" >
	<tbody>
	<?php
