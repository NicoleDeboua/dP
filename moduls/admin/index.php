...
if (!(getPermission('users', 'view'))) { $AppUI->redirect('m=public&a=access_denied');}

$AppUI->savePlace();

if (isset($_GET['tab'])) { $AppUI->setState('UserIdxTab', $_GET['tab']); }
...
$titleBlock = new CTitleBlock('User Management', 'logo_users.gif', $m, "$m.$a");
