<?php /* PROJECTS $Id$ , addedit.php [v.????] 2020-03-10 , dP-v.2.2.0 */
...
$companies_internal = $row->listCompaniesByType(array('6')); // get internal companies
$companies_internal = arrayMerge(array('0'=>''), $companies_internal); // 6 is standard value for internal companies
...
if (!$row->load($project_id, false) && $project_id > 0) { $AppUI->setMsg('Project'); $AppUI->setMsg("invalidID", UI_MSG_ERROR, true);	$AppUI->redirect(); }
...
$df = $AppUI->getPref('SHDATEFORMAT'); // format dates
...
$titleBlock = new CTitleBlock($ttl, 'logo_project-addedit.gif', $m, "$m.$a");
...
<script src="<?php echo DP_BASE_URL;?>/lib/calendar/calendar.js"></script> <!-- import the calendar script -->
<script src="<?php echo DP_BASE_URL;?>/lib/calendar/lang/calendar-<?php echo $AppUI->user_locale; ?>.js"></script> <!-- import the language module -->
...
<tr>
	<th align="center" colspan="2"><?php echo $AppUI->_('New Project');?></th>
</tr>
<tr>
	<td><input class="button" type="button" name="cancel" value="<?php echo $AppUI->_('cancel');?>" onclick="javascript:if (confirm('Are you sure you want to cancel.')) {location.href = '?m=projects';}" /></td>
	<td align="right"><input class="button" type="button" name="btnFuseAction" value="<?php echo $AppUI->_('submit');?>" onclick="javascript:submitIt();" /></td>
</tr>
	...
	<td width="50%" valign="top">
		...
		<tr>
			...
			<td width="100%" colspan="2">
				<input autofocus type="text" name="project_name" value="<?php echo dPformSafe($row->project_name);?>" size="50" maxlength="50" onblur="javascript:setShort();" class="text" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="3">
				<?php echo arraySelect($ptype, 'project_type', 'class="text" size="1" style="width:200px;"', $row->project_type, true);?>
			</td>
		</tr>
		<tr>
			<td align="right" nowrap="nowrap"> (*) <?php echo $AppUI->_('Status');?></td>
			<td colspan="3"><?php echo arraySelect($pstatus, 'project_status', 'class="text" size="1" style="width:200px;"', $row->project_status, true); ?></td>
		</tr>
		<tr>
			<td align="right" nowrap="nowrap"><?php echo $AppUI->_('Progress');?></td>
			<td colspan="3"><strong><?php echo sprintf("%.1f%%", @$row->project_percent_complete);?></strong></td>
		</tr>
		<tr>
			<td align="right" nowrap="nowrap"><?php echo $AppUI->_('Project Owner');?></td>
			<td colspan="2"><?php echo arraySelect($users, 'project_owner', 'class="text" size="1" style="width:200px;" ', $row->project_owner? $row->project_owner : $AppUI->user_id) ?></td>
		</tr>
		<tr>
			<td align="right" nowrap="nowrap"> (*) <?php echo $AppUI->_('Company');?></td>
			<td width="100%" nowrap="nowrap" colspan="2"><?php	echo arraySelect($companies, 'project_company', 'class="text" size="1"style="width:200px;" ', $row->project_company); ?></td>
		</tr>
		<tr>
			<td align="right" nowrap="nowrap"><?php echo $AppUI->_('Internal Division');?></td>
			<td width="100%" nowrap="nowrap" colspan="2">
<?php
		echo arraySelect($companies_internal, 'project_company_internal', 'class="text" size="1" style="width:200px;" ', $row->project_company_internal);
?></td>
 		</tr>
		<tr>
...
<tr>
	...
	<td width="50%" valign="top">
		...
		<tr>
			<td align="left" nowrap="nowrap"><?php echo $AppUI->_('Import tasks from');?>:<br/></td>
			<td colspan="3"><?php
		...
		<tr>
			<td align="left" nowrap="nowrap"><?php echo $AppUI->_('Scale Imported Tasks');?>:<br/></td>
			<td colspan="3"><input type="checkbox" name="scale_project" id="scale_project" value="1" /></td>
		</tr>
		<tr>
			<td colspan="4"><?php
	...
	<tr>
		<th align="left" nowrap="nowrap" colspan="2" ><?php echo $AppUI->_('Custom Fields');?> : </th>
	</tr>
	<tr>
