...
if ($task_id) {
	...
	if ($canEdit) { $canEdit = getPermission('tasks', 'add'); }
}
...
function submitIt(document.editFrm) {
...
echo $AppUI->getPlace(); ?>';}" />
			...
			<td>
				<input class="button" type="button" name="btnFuseAction" href="#" 
					onclick="javascript:submitIt(document.editFrm); return false;" value="<?php echo $AppUI->_('save'); ?>"/>
			</td>
		</tr>
		</table>
	</td>
