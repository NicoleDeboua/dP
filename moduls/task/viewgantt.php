...
<table border="0" cellpadding="4" cellspacing="0">
	<tr>
		<td align="left" valign="top" width="20"><?php if ($display_option != "all") { ?>
		...
		<td valign="top">
			<input type="checkbox" name="showWork" id="showWork" <?php echo (($showWork == 1) ? 'checked="checked"' : ''); ?> />
			<label for="showWork"><?php echo $AppUI->_('Show work instead of duration'); ?></label>
		</td>	
		<td valign="top">
			<input type="checkbox" name="sortByName" id="sortByName" <?php echo (($sortByName == 1) ? 'checked="checked"' : ''); ?> />
			<label for="sortByName"><?php echo $AppUI->_('Sort by Task Name'); ?></label>
		</td>	
		<td align="left">
		...
		<td align="right" valign="top" width="20">
			<?php if ($display_option != "all") { ?>
	  		<a href="javascript:scrollNext()"><img src="./images/next.gif" width="16" height="16" alt="<?php echo $AppUI->_('next');?>" border="0" /></a>
			<?php } ?>
		</td>
	</tr>
	<?php if ($a == 'todo') { ?>
	...
	<tr>
		<td align="center" valign="bottom" colspan="7">
			...
			<a href='javascript:showFullProject()'><?php echo (($a == 'todo') ? $AppUI->_('show all') : $AppUI->_('show full project')); ?></a>
		</td>
	</tr>
</table>
</form>
...
<table cellspacing="0" cellpadding="0" border="1" align="center">
	...
	<tr>
		<td>
			<span style="color: red; font-weight: bold;"><?php echo $AppUI->_('invalid memory config'); ?></span>
			<?php }
			} else { echo $AppUI->_('No tasks to display'); }
			?>
		</td>
	</tr>
</table>
