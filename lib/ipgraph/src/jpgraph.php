...
if(USE_CACHE) {
    if (!defined('CACHE_DIR')) {
        if ( strstr( PHP_OS, 'WIN') ) {
            ...
            else { define('CACHE_DIR', $_SERVER['TEMP'] . '/'); }
        } else { define('CACHE_DIR','/tmp/jpgraph_cache/');  }
    }
}
elseif( !defined('CACHE_DIR') ) { define('CACHE_DIR', '');}
...
if (!defined('TTF_DIR')) {
    if (strstr( PHP_OS, 'WIN') ) {
        ...
        else { define('TTF_DIR', $sroot.'/fonts/');  }
    } else { define('TTF_DIR','/usr/share/fonts/truetype/'); }
}
...
if (!defined('MBTTF_DIR')) {
    if (strstr( PHP_OS, 'WIN') ) {
        ...
        else { define('MBTTF_DIR', $sroot.'/fonts/'); }
    } else { define('MBTTF_DIR','/usr/share/fonts/truetype/'); }
}
